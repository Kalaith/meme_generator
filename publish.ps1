...
# Configuration
$SOURCE_DIR = "H:\WebHatchery\apps\meme_generator"
...
$DEST_DIR = Join-Path $DEST_ROOT "meme_generator"
...
function Build-Frontend {
    ...
    # Set base path for preview environment (meme_generator subdirectory)
    if ($Environment -eq 'preview') {
        Write-Info "Setting base path for preview environment..."
        $env:VITE_BASE_PATH = "/meme_generator/"
